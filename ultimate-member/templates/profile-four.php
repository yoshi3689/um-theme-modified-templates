...
if ( $args['template'] == 'profile-four' ) {
	...
	add_action( 'um_profile_header', 'um_theme_profile_layout_four_header', 12 );
	...
	if ( class_exists( 'UM_Friends_API' ) ) {
		...
		add_action( 'um_profile_layout_four_second', 'um_theme_friends_add_button', 21 );
	}
	...
	if ( class_exists( 'UM_Messaging_API' ) ) {
		...
		add_action( 'um_profile_layout_four_second', array( UM()->Messaging_API()->profile(), 'add_profile_bar' ), 22 );
	}
}

?>
<div class="um um-profile-four-container <?php echo esc_attr( $this->get_class( $mode ) ); ?> um-<?php echo esc_attr( $form_id ); ?> um-role-<?php echo esc_attr( um_user( 'role' ) ); ?> ">
	<div class="um-form" data-mode="<?php echo esc_attr( $mode ) ?>">
		...
		<div class="boot-row">
			<div class="boot-col-md-12 um-profile-four">
			...
			<div class="boot-col-md-12 um-profile-four-content">
