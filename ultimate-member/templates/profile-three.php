...
if ( $args['template'] == 'profile-three' ) {

	add_action( 'um_profile_layout_two', 'um_theme_below_profile_layout_three_image_open', 10 );
...
<div class="um um-custom-profile-container <?php echo esc_attr( $this->get_class( $mode ) ); ?> um-<?php echo esc_attr( $form_id ); ?> um-role-<?php echo esc_attr( um_user( 'role' ) ); ?> ">
	<div class="um-form" data-mode="<?php echo esc_attr( $mode ) ?>">
		...
		<?php } ?>
			...
			<div class="boot-row">
			<div class="boot-col-md-2 um-profile-three">
				<?php
				/**
				 * UM hook
				 *
			...
			<div class="boot-col-md-10 um-profile-three-content">
